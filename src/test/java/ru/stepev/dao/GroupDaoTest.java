...
public class GroupDaoTest {
	...
	public void givenCreate_whenGroupCreate_thenGroupWasCreated() throws Exception {
		...
		students.add(new Student(1, 123, "Peter", "Petrov", LocalDate.of(2020, 9, 3), "webPP@mail.ru", Gender.MALE, "City17",
				courses));
	...
	public void givenUpdateGroupById_whenGroupUpdate_thenGroupWasUpdated() throws Exception {
		...
		courses.add(new Course(2, "Biology", "Bio"));
		List<Student> students = new ArrayList<>();
		students.add(new Student(3, 125, "Peter", "Ivanov", LocalDate.of(2020, 9, 5), "webPI@mail.ru", Gender.FEMALE, "City19",
				courses));
		students.add(new Student(5, 227, "Irina", "Stepanova", LocalDate.of(2020, 9, 7), "Ivanov@mail.ru", Gender.FEMALE, "City11",
				courses));
	...
	@Order(6)
	@Test
	public void givenAssignStudentsToGroup_whenStudentAssignToGroup_thenStudentWasAssignedToGroup() throws Exception {
		List<Course> courses = new ArrayList<>();
		courses.add((new Course(3, "Chemistry", "Chem")));
		courses.add((new Course(4, "Physics", "Phy")));
		List<Student> students = new ArrayList<>();
