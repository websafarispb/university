...
public class JdbcLectureDao implements LectureDao {
	...
	private static final String FIND_AND_SORT_BY_TIME = "SELECT * FROM lectures ORDER BY local_time ASC LIMIT ? OFFSET ?";
	private static final String FIND_AND_SORT_BY_COURSE = "SELECT * FROM lectures INNER JOIN courses ON courses.id = lectures.course_id ORDER BY course_name ASC LIMIT ? OFFSET ?";
	private static final String FIND_AND_SORT_BY_CLASSROOM = "SELECT * FROM lectures INNER JOIN classrooms ON classrooms.id = lectures.classroom_id ORDER BY classroom_address  ASC LIMIT ? OFFSET ?";
	private static final String FIND_AND_SORT_BY_GROUP = "SELECT * FROM lectures INNER JOIN groups ON groups.id = lectures.group_id ORDER BY group_name ASC LIMIT ? OFFSET ?";
	private static final String FIND_AND_SORT_BY_TEACHER = "SELECT * FROM lectures INNER JOIN teachers ON teachers.id = lectures.teacher_id ORDER BY last_name ASC LIMIT ? OFFSET ?";
