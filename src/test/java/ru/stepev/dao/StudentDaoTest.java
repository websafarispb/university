...
public class StudentDaoTest {
	...
	@Test
	public void givenUpdateStudentNotExist_whenUpdateStudentById_thenGEtObjectNotFoudException() throws Exception {
		List<Course> coursesForStudent = new ArrayList<>();
		coursesForStudent.add(new Course(1, "Mathematics", "Math"));
		coursesForStudent.add(new Course(2, "Biology", "Bio"));
		coursesForStudent.add((new Course(3, "Chemistry", "Chem")));
		coursesForStudent.add((new Course(4, "Physics", "Phy")));
		Student student = new Student(200, 328, "Ivan", "Stepanov", LocalDate.of(2020, 9, 1), "Stepanov@mail.ru", Gender.MALE, "City11",
				coursesForStudent);
		try {
			studentDao.update(student);
			fail("Expected Exception");
		} catch (Exception e) {
			assertEquals("Student with Id = 200 not found !!!", e.getMessage());
		}
	}
	...
	@Test
	public void givenDeleteStudentNotExist_whenDeleteStudentById_thenGEtObjectNotFoudException() throws Exception {
		try {
	...
	@Test
	public void givenFindStudentByIdNotExist_whenFindStudentById_thenGEtObjectNotFoudException() throws Exception {
		try {
